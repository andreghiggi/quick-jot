...
- [Print V2 Group/Address](mem://features/print-group-label-address-v2) — Comanda/recibo V2 (I9) com `[ADDGROUP_LABEL]` (■ sublinhado, sem CAPS, omitido se 1 grupo) e `[ENDERECO]` invertido. Requer auto_printer.py v8.32+.
