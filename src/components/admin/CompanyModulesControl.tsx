...
const AVAILABLE_MODULES = [
  ...
  {
    name: 'mercado',
    label: 'Loja / Frente de Caixa',
    description: 'Habilita recursos para lojas/mini mercados: busca por código de barras (GTIN) e SKU no PDV, leitura de etiquetas EAN-13 pesáveis e (em breve) Frente de Caixa dedicado. Não altera nada do fluxo atual — só adiciona.'
  },
  {
    name: 'cardapio',
