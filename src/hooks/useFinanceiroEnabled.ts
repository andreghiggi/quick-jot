 ...
 * Espelha o padrão de `useMercadoEnabled` — cacheia em localStorage para
 * evitar flash de UI.
 *
 * IMPORTANTE: este hook só LIGA features novas do Financeiro (Crediário /
 * Contas a Receber / Contas a Pagar). Nunca deve alterar comportamento
 * existente quando desativado.
 */
