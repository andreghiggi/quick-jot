...
if (SUPABASE_URL.includes('comandatech.com.br') && !SUPABASE_URL.includes('supabase.co')) {
  reportConfigError('Build aponta para API self-hosted. Use Supabase Cloud (Lovable).');
}
