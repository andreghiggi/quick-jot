...
const changelog: ChangelogEntry[] = [
  {
    ...
    version: '1.22.3-beta',
    type: 'fix',
    description: 'Impressão V2: corrigida a origem que ainda mandava adicionais como lista plana para Margen e demais lojas V2. Cardápio público e Pedido Express agora enviam os grupos estruturados para qualquer loja com Layout V2/V3 ativo — pizzas com 2+ grupos passam a imprimir o rótulo do grupo com ■ sublinhado e itens abaixo; 1 grupo continua só com os itens em "+". O auto_printer.py v8.38 já estava pronto para interpretar isso. TEF, PinPad, NFC-e, Multi-Pagamento, cobranças e V1 não foram alterados.',
  },
  {
    date: '15/06/2026',
    version: '1.22.2-beta',
  ...
  },
  {
    ...
    version: '1.18.0-beta',
    type: 'feature',
    description: 'Frente de Caixa (módulo Mercado) — ajustes por item estilo Gweb. Clique com o botão direito sobre qualquer linha do carrinho abre um menu de contexto com "Alterar preço" (atalho Home) e "Editar detalhes" (atalho Ctrl+D). Os atalhos agem sobre o último item tocado. Novo modal "Alteração no preço do item" com 3 modos selecionáveis por hotkey: Desconto (−), Alteração no valor unitário (=) e Acréscimo (+) — tudo por linha, separado do desconto/acréscimo da venda toda. Novo modal "Editar detalhes" (aba IDENTIFICAÇÃO — aba ADICIONAIS ainda não disponível) edita quantidade, valor unitário e desconto da linha, mostra Código/GTIN, Quantidade convertida e Valor total recalculado em tempo real; botão REMOVER (vermelho) descarta a linha. Cada linha do carrinho passa a mostrar o preço efetivo com o original riscado (quando houver override) e chips "− R$ X,XX desc." / "+ R$ Y,YY acr." separados. Persistência: ajustes vão para notes da venda como linhas próprias ("Item N PRODUTO: preço A → B", "Item N PRODUTO: desconto R$ X", "Item N PRODUTO: acréscimo R$ Y") e o unit_price gravado em pdv_sale_items reflete o valor efetivo da linha. Nada de PDV V2, OrderCardChargeDialog, Pedido Express, TEF v1.0/v1.1/v1.2-beta, Multi-Pagamento v1.6/v1.7, NFC-e ou impressão foi tocado.',
  },
  {
    date: '09/06/2026',
    version: '1.17.0-beta',
