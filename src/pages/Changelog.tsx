...
const changelog: ChangelogEntry[] = [
  {
    ...
    version: '1.24.0',
    type: 'feature',
    description: 'Fluxo Confirmar → Preparar: botão "Preparar" começa desabilitado até clicar em "Confirmar". Após confirmação, "Confirmar" fica cinza e "Preparar" fica ativo em vermelho. Aplicado a todas as lojas.',
  },
  {
    date: '10/04/2026',
    version: '1.24.0',
    type: 'feature',
    description: 'Adicionais agrupados no pedido: itens extras agora aparecem separados por nome do grupo (ex: "Frutas: Manga, Abacaxi"), com preços individuais para itens pagos. Aplicado a todas as lojas.',
  },
  {
    date: '10/04/2026',
    version: '1.24.0',
    type: 'improvement',
    description: 'Cards de pedido enriquecidos: exibição de método de pagamento (💳), modalidade (🛵 Entrega / 🤲 Retirada), troco (💵), e observações por item. Aplicado a todas as lojas.',
  },
  {
    date: '10/04/2026',
    version: '1.23.0',
  ...
  },
  {
    ...
    version: '1.16.0',
    type: 'feature',
    description: 'Ordenação de produtos: arrastar ou definir ordem de exibição dos itens dentro de cada categoria.',
  },
  {
    date: '27/03/2026',
    version: '1.16.0',
