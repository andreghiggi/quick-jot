...
export default function PDVV2() {
  ...
  const i9SplitInfoRef = useRef<typeof i9SplitInfo>(null);
  function setI9Split(val: typeof i9SplitInfo) {
      ...
      <PDVV2PaymentDialog
        ...
        onSplitPaid={isI9 ? async (perPerson, totalPeople) => {
          ...
          if (!i9SplitInfoRef.current) {
            ...
            const currentSplit = i9SplitInfoRef.current;
            const newRemaining = currentSplit.remaining - 1;
            if (newRemaining <= 0) {
              ...
              setI9Split({ ...currentSplit, remaining: newRemaining });
