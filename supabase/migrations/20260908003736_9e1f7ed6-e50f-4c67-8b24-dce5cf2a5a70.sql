-- lovable-cron-fallback-reviewed: 288 runs/day; backstop de reconciliação fiscal — destrava NFC-e presas em processando e reconcilia órfãs quando o webhook falha; não há evento que dispare esse caso
